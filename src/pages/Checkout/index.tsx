...
import { clear } from '../../../src/store/reducers/carts'
  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
      fullName: Yup.string()
        ...
        .required('O campo é obrigatótio'),
      email: Yup.string()
      ...
      {isSuccess && data ? (
        <Card title="Muito Obrigado">
          <>
            ...
            <p className="margin-top">
              ...
              através dos nossos canais de atendimento ao cliente. Agradecemos
              por escolher a EPLAY e esperamos que desfrute do seu jogo!
            </p>
          </>
        </Card>
      ) : (
        <form onSubmit={form.handleSubmit}>
          ...
          <Button
            ...
            title="clique aqui para finaliza a compra"
            disabled={isLoading}
          >
